---
title: User Config
description: How SeaPack handles user config
---

Users can configure SeaPack in a few different ways:
...
SeaPack to perform optimizations after the config is applied. It also allows
